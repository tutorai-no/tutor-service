...
class RetrievalClient:
    ...
    def get_context(
        ...
        """
        try:
            params = {"course_id": course_id, "query": query, "limit": limit}

            if document_ids:
                params["document_ids"] = document_ids

            response = self.session.get(
                f"{self.base_url}/search/context", params=params
            )
            response.raise_for_status()
    ...
    def search_documents(
        ...
        try:
            ...
            response = self.session.get(
                f"{self.base_url}/search/documents", params=params
            )
            response.raise_for_status()
    ...
    def get_page_range(self, document_id: int, start_page: int, end_page: int) -> str:
        ...
        try:
            ...
            response = self.session.get(
                f"{self.base_url}/documents/{document_id}/pages", params=params
            )
            response.raise_for_status()
            ...
            logger.info(
                f"Retrieved pages {start_page}-{end_page} from document {document_id}"
            )
    ...
    def get_document_embeddings(self, document_id: int) -> dict[str, Any]:
        ...
        try:
            response = self.session.get(
                f"{self.base_url}/documents/{document_id}/embeddings"
            )
            response.raise_for_status()
            return response.json()
        except requests.RequestException as e:
