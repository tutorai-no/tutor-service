...
class StudyPlanSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'start_date', 'end_date', 'target_exam_date',
            'daily_study_hours', 'study_days_per_week',
            'plan_data', 'total_tasks', 'completed_tasks',
            'progress_percentage', 'is_active',
            'generated_at', 'last_updated', 'created_at', 'updated_at'
        ]
        read_only_fields = ['user', 'generated_at', 'last_updated', 'created_at', 'updated_at']
...
class StudyPlanCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = StudyPlan
        fields = [
            'course', 'title', 'description', 'plan_type',
            'start_date', 'end_date', 'target_exam_date',
            'daily_study_hours', 'study_days_per_week'
        ]
...
class StudyGoalSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'is_ai_suggested', 'ai_rationale',
            'streak_count', 'best_streak', 'last_progress_date',
            'progress_percentage', 'is_overdue',
            'created_at', 'updated_at'
        ]
        read_only_fields = ['user', 'completed_date', 'streak_count', 'best_streak', 'last_progress_date', 'created_at', 'updated_at']
...
class StudyGoalCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = StudyGoal
        fields = [
            'course', 'study_plan', 'title', 'description', 'goal_type',
...
class LearningProgressSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'progress_type', 'identifier',
            'completion_percentage', 'mastery_level', 'confidence_score',
            'total_study_time', 'last_studied',
            'quiz_average', 'flashcard_retention',
...
class StudySessionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'topics', 'materials', 'completion_notes',
            'satisfaction_rating', 'productivity_rating',
            'objectives_completed', 'total_objectives',
            'duration_planned', 'duration_actual',
            'created_at', 'updated_at'
        ]
        read_only_fields = ['user', 'actual_start', 'actual_end', 'created_at', 'updated_at']
...
class StudySessionCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = StudySession
        fields = [
            'course', 'study_plan', 'title', 'description', 'session_type',
            'scheduled_start', 'scheduled_end', 'topics', 'materials',
            'total_objectives'
        ]
...
class StudyRecommendationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'user_feedback', 'effectiveness_rating',
            'is_expired', 'created_at', 'updated_at'
        ]
        read_only_fields = ['user', 'accepted_at', 'dismissed_at', 'created_at', 'updated_at']
