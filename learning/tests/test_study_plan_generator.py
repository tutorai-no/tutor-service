...
from learning.models import StudyGoal, StudyPlan
...
class TestStudyPlanGeneratorService(TestCase):
    ...
    def test_create_optimized_schedule(self):
        ...
        performance_analysis = {
            ...
            "learning_velocity": {"topics_per_week": 3, "mastery_rate": 0.75},
        }
    ...
    def test_adapt_to_performance_patterns(self):
        ...
        performance_analysis = {
            ...
            "quiz_performance": {"weak_topics": ["Django Models"], "strong_topics": []},
        }
    ...
    def test_error_handling(self, mock_logger):
        ...
        result = self.service.generate_adaptive_study_plan(
            user=None, course=self.course, plan_type="weekly", preferences={}
        )
    ...
    def test_weekend_inclusion_preference(self):
        ...
        preferences_with_weekends = {"daily_hours": 2.0, "include_weekends": True}

        preferences_without_weekends = {"daily_hours": 2.0, "include_weekends": False}
    ...
    def test_short_session_preference(self):
        ...
        preferences = {"daily_hours": 2.0, "prefer_short_sessions": True}
