...
from learning.models import StudyPlan, StudyGoal, LearningProgress, StudySession
...
class TestProgressPredictionService(TestCase):
    ...
    def test_calculate_learning_velocity(self):
        ...
        self.assertIn(velocity['velocity_trend'], ['Accelerating', 'Stable', 'Declining'])
    ...
    def test_generate_prediction_recommendations(self):
        ...
        recommendations = self.service._generate_prediction_recommendations(prediction_data)
        ...
        self.assertIn('velocity' in rec_text.lower() or 'consistency' in rec_text.lower(), True)
    ...
    def test_different_target_mastery_levels(self):
        ...
        for target_level in [3, 4, 5]:
            ...
            self.assertTrue(result['success'], f"Failed for mastery level {target_level}")
    ...
    def test_realistic_completion_scenarios(self):
        ...
        self.assertGreater(completion['completion_probability'], 0.8)  # High probability
