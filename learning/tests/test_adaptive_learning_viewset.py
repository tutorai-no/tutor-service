...
from learning.models import LearningProgress, StudyPlan
...
class TestAdaptiveLearningViewSet(TestCase):
    ...
    def test_generate_adaptive_plan_with_target_date(self):
        ...
        data = {
            ...
            "preferences": {"daily_hours": 3.0, "high_intensity": True},
        }
    ...
    def test_generate_adaptive_plan_missing_course_id(self):
        ...
        url = "/api/v1/learning/adaptive/generate-adaptive-plan/"
        data = {"plan_type": "weekly", "preferences": {"daily_hours": 2.0}}
    ...
    def test_manual_override_difficulty_adjustment(self):
        ...
        data = {
            ...
            "override_data": {"adjustment": 1},  # Make harder
    ...
    def test_manual_override_review_frequency(self):
        ...
        data = {
            ...
            "override_data": {"frequency_days": 5},
    ...
    def test_manual_override_missing_data(self):
        ...
        url = "/api/v1/learning/adaptive/manual-override/"
        data = {"override_type": "schedule", "reason": "Test reason"}
    ...
    def test_course_access_control(self):
        ...
        other_course = Course.objects.create(
            name="Other Course", description="Another user's course", user=other_user
        )
    ...
    def test_preferences_validation(self):
        ...
        data = {
            "course_id": str(self.course.id),
            "plan_type": "weekly",
            "preferences": {"daily_hours": -1},  # Invalid negative hours
        }
    ...
    def test_concurrent_plan_generation(self):
        ...
        for i, response in enumerate(responses):
            self.assertEqual(
                response.status_code, status.HTTP_201_CREATED, f"Request {i} failed"
            )
            self.assertTrue(response.data["success"])
    ...
    def test_service_error_handling(self, mock_logger):
        ...
        with patch(
            "learning.services.study_plan_generator.StudyPlanGeneratorService.generate_adaptive_study_plan"
        ) as mock_service:
    ...
    def test_manual_override_logs_changes(self):
        ...
        data = {
            "study_plan_id": str(self.study_plan.id),
            "override_type": "schedule",
            "override_data": {"session_id": "session_123", "new_date": "2024-01-15"},
    ...
    def test_plan_generation_response_format(self):
        ...
        required_fields = ["success", "study_plan_id", "plan_data", "recommendations"]
