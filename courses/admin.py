...
class CourseAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Basic Information", {"fields": ("user", "name", "description")}),
        (
            "Academic Context",
            {
                "fields": (
        ...
        ("Important Dates", {"fields": ("start_date", "end_date", "exam_date")}),
        ("Status", {"fields": ("is_active", "is_archived", "is_favorite")}),
        (
            "Statistics",
            {
                "fields": (
...
class CourseSectionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Section Information", {"fields": ("course", "name", "description", "order")}),
        (
            "Academic Context",
            {"fields": ("chapter_number", "page_range_start", "page_range_end")},
        ),
        ("Content", {"fields": ("learning_objectives", "key_concepts")}),
        (
            "Progress",
            {
                "fields": (
...
class DocumentAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Usage Statistics", {"fields": ("view_count", "last_accessed_at")}),
        ("Status", {"fields": ("is_favorite", "is_archived")}),
        (
            "Timestamps",
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
        ),
