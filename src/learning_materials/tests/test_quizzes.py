...
class QuizGenerationTests(TestCase):
    ...
    def test_generate_quiz(self, mock_get_page_range):
        ...
        pages = [
            Citation(
                text="""Artiﬁcial Intelligence (AI) is the branch of computer science, which makesthe computers to mimic the human behavior to assist humans for better performance in the field of science and technology.""",
                page_num=start,
                document_name=document_name,
            ),
            Citation(
                text="""Replicating human intelligence, solving knowledge-intensive tasks, building machines, which can perform tasks, that requirehuman intelligence, creating some system which can learn by itself are the few speciﬁc goals of AI. 
