...
class TestFlashcardGenerationService(BaseTestCase):
    ...
    @patch('assessments.services.generators.flashcard_service.ContentGenerationOrchestrator')
    def test_setup_agents_success(self, mock_orchestrator_class):
        """Test successful agent setup"""
        mock_orchestrator = Mock()
        mock_orchestrator_class.return_value = mock_orchestrator
        
        with patch('assessments.services.generators.flashcard_service.create_flashcard_agent') as mock_create_agent:
            mock_agent = Mock()
    ...
    def test_setup_agents_failure(self, mock_orchestrator_class):
        ...
        with patch('assessments.services.generators.flashcard_service.create_flashcard_agent', 
    ...
    def test_generate_flashcards_success(self):
        ...
        with patch.object(self.service.orchestrator, 'orchestrate_generation', return_value=mock_results):
    ...
    def test_generate_flashcards_with_auto_save(self):
        ...
        with patch.object(self.service.orchestrator, 'orchestrate_generation', return_value=mock_results):
            with patch.object(self.service, '_save_flashcards_to_db') as mock_save:
                mock_save.return_value = [{"id": "123", "question": "Test?", "answer": "Test."}]
    ...
    def test_get_generation_recommendations_with_content(self):
        ...
        with patch.object(self.service.orchestrator, 'get_agent_recommendations') as mock_recommendations:
    ...
    def test_get_generation_recommendations_error(self):
        ...
        with patch.object(self.service.orchestrator, 'get_agent_recommendations', 
...
class TestFlashcardServiceFactory(TestCase):
    ...
    @patch('assessments.services.generators.flashcard_service.FlashcardGenerationService')
