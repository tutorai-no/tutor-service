...
class FlashcardAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Configuration", {"fields": ("difficulty_level", "tags", "source_content")}),
        (
            "Spaced Repetition",
            {
                "fields": (
        ...
        ("Status", {"fields": ("is_active", "is_starred")}),
        (
            "AI Generation",
...
class FlashcardReviewAdmin(admin.ModelAdmin):
    ...
    def flashcard_preview(self, obj):
        return (
            obj.flashcard.question[:30] + "..."
            if len(obj.flashcard.question) > 30
            else obj.flashcard.question
        )
    ...
    fieldsets = (
        ...
        ("Context", {"fields": ("study_session_id", "device_type")}),
        (
...
class QuizAdmin(admin.ModelAdmin):
    ...
    list_filter = ["quiz_type", "status", "generated_by_ai", "created_at"]
...
class QuizAttemptAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Scoring", {"fields": ("score", "max_score", "percentage_score", "passed")}),
        ("Timing", {"fields": ("time_taken_seconds", "started_at", "completed_at")}),
        ("Configuration", {"fields": ("questions_order",)}),
        ("Context", {"fields": ("device_type", "ip_address", "user_agent")}),
    )
...
class QuizResponseAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Timing", {"fields": ("time_taken_seconds", "answered_at")}),
        ("Review", {"fields": ("flagged_for_review",)}),
    )
...
class AssessmentAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Scheduling", {"fields": ("due_date", "estimated_duration_minutes")}),
        ("Results", {"fields": ("completion_rate", "average_performance")}),
        ("Status", {"fields": ("status",)}),
        (
            "Timestamps",
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
...
class StudyStreakAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ["id", "milestones_achieved", "created_at", "updated_at"]

    fieldsets = (
        ("Streak Information", {"fields": ("user", "course", "streak_type")}),
        (
            "Streak Data",
            {
                "fields": (
        ...
        ("Milestones", {"fields": ("milestones_achieved",)}),
        (
            "Timestamps",
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
        ),
