...
class User(AbstractUser):
    ...
    study_level = models.CharField(max_length=50, choices=[
        ('bachelor', 'Bachelor'),
        ('master', 'Master'),
        ('phd', 'PhD'),
        ('other', 'Other'),
    ...
    daily_study_goal_minutes = models.PositiveIntegerField(default=60, null=True, blank=True)
...
class UserProfile(models.Model):
    ...
    # Study preferences
    study_style = models.CharField(max_length=20, choices=[
        ('visual', 'Visual'),
        ('auditory', 'Auditory'),
...
class UserActivity(models.Model):
    ...
    resource_type = models.CharField(
        ...
        help_text="e.g., course, quiz, flashcard"
    )
...
class UserStreak(models.Model):
    ...
    streak_milestones_achieved = models.JSONField(
        default=list, 
        help_text="List of streak milestones reached (e.g., [7, 14, 30])"
    )
...
class UserApplication(models.Model):
    ...
    motivation = models.TextField(
        ...
        help_text="Why they want to use Aksio"
    )
